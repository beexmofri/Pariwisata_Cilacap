...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        password = (EditText)findViewById(R.id.editTextPasswordRegist);
        passwordConf = (EditText)findViewById(R.id.editTextPasswordRegistConf);
        login = (Button)findViewById(R.id.buttonLogin1);
        register = (Button)findViewById(R.id.buttonRegist1);
